...
var UseCase = /** @class */ (function () {
    ...
    UseCase.prototype.createReservation = function (reservation) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.repository.createReservation(reservation)];
                    case 1:
    ...
    UseCase.prototype.deleteReservation = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.repository.deleteReservation(id)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    UseCase.prototype.getAllReservation = function () {
        return __awaiter(this, void 0, void 0, function () {
            var reservations, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.repository.getAllReservation()];
                    case 1:
